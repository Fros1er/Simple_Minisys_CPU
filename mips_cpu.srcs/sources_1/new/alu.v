...
wire[31:0] signextimm, zeroextimm;
    ...
    if (alu_en) begin
        if (type == 1) begin
            case(funct)
                ...
                6'b10_0000: result = rs_val + rt_val; // add
                6'b10_0001: result = rs_val + rt_val; // addu, TODO
                6'b10_0010: result = rs_val - rt_val; // sub
            ...
            case (opcode)
                ...
                6'b00_1000: result = rs_val + signextimm; // addi
                6'b00_1001: result = rs_val + signextimm; // addiu, TODO
                6'b00_1010: result = ($signed(rs_val) < $signed(signextimm)) ? 1 : 0; // slti
                6'b00_1011: result = (rs_val < signextimm) ? 1 : 0; // sltiu, TODO
